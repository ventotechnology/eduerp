...
test.describe('Super Admin Complete Route Smoke & Real Browser Certification', () => {
  ...
  const SUPER_ADMIN_ROUTES = [
    { path: '/super-admin', heading: /SaaS Platform Overview|Platform Overview|Super Admin/i },
    { path: '/super-admin/institutions', heading: /Institution Tenants|Institutions/i },
    { path: '/super-admin/subscriptions', heading: /Subscriptions & ARR|Subscriptions/i },
    { path: '/super-admin/plans', heading: /Plans & Pricing|SaaS Plans/i },
    { path: '/super-admin/orders', heading: /Orders & Revenue|Subscription Orders/i },
    { path: '/super-admin/gateways', heading: /Payment Gateways/i },
    { path: '/super-admin/reconciliation', heading: /Payment Reconciliation/i },
    { path: '/super-admin/sms', heading: /SMS Gateway Control Plane|Universal SMS/i },
    { path: '/super-admin/support', heading: /Super Admin Support Command Center|Support Desk/i },
    { path: '/super-admin/support/tickets', heading: /Ticket Queue|Cross-Tenant Ticket Queue/i },
    { path: '/super-admin/inquiries', heading: /Sales Inquiries/i },
    { path: '/super-admin/knowledge', heading: /Knowledge Base/i },
    { path: '/super-admin/faqs', heading: /FAQs CMS|Frequently Asked Questions/i },
    { path: '/super-admin/releases', heading: /Release Notes/i },
    { path: '/super-admin/users', heading: /Platform Administrators & Roles|Platform Users/i },
    { path: '/super-admin/contact-settings', heading: /Platform Contact Settings|Contact Settings/i },
    { path: '/super-admin/sla', heading: /Support SLA Engine|SLA Policies/i },
    { path: '/super-admin/demo-credentials', heading: /Client Demo Credential Vault|Demo Vault/i },
    { path: '/super-admin/settings', heading: /Platform Settings/i },
    { path: '/super-admin/audit', heading: /Audit Trail & Security Logs|Audit Logs/i },
    { path: '/super-admin/health', heading: /System Health & Infrastructure|System Health/i },
  ];
