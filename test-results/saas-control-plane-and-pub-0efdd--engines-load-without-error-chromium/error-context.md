...
- Name: saas-control-plane-and-public.spec.ts >> COMMAND 11D — SaaS Control Plane, Public Pages & Vertical Admissions >> 5. Public Admissions on multiple vertical engines load without error
- Location: tests/e2e/saas-control-plane-and-public.spec.ts:88:7
...
Locator: getByText(/Admission/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Admission/i).first()
...
- link:
  - /url: /
- heading "Sign In to EduERP" [level=2]
- paragraph: The Universal Operating System for Education Institutions
- text: Official Email / Username
- textbox "Official Email / Username":
  - /placeholder: e.g. principal.demo-school@eduerp.us
- text: Password
- textbox "Password":
  - /placeholder: ••••••••••••
- button
- text: Institution Domain / Tenant Slug (Optional)
- textbox "Institution Domain / Tenant Slug (Optional)":
  - /placeholder: e.g. demo-school or demo-university
- button "Sign In Securely"
- paragraph: Need assistance? Contact your institution IT administrator or platform support.
- link "← Return to EduERP Landing Page":
  - /url: /
- alert
```
